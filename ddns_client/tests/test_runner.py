...
def test_check_for_ipv4_change(mock_get_private_key, mock_setup_paramiko, mock_exec_command, mock_get_wan_ip):
    ...
    with patch.object(cloudfare_client, "get_cloudfare_record_id") as mock_get_record_id:
